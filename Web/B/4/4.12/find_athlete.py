...
class Athelete(Base):
    """
    Describes the structure of the athlete table containing athlete data
    """
...
class User(Base):
    """
    Describes the structure of the user table containing user data
    """
    __tablename__ = 'user'
...
def convert_str_to_date(date_str):
    """
    Converts a date string in the format YYYY-MM-HH to a datetime.date object
    """
...
def nearest_by_bd(user, session):
    """
    Searches for the closest athlete by birth date to user user
    """
...
def nearest_by_height(user, session):
    """
    Searches for the closest athlete to user
    """
    athletes_list = session.query(Athelete).all()
...
def main():
    ...
    if not user:
        ...
        print(
            "Nearest athlete by date of birth: {}, his date of birth: {}".format(bd_athlete, bd)
        )
        print(
            "The athlete closest in height: {}, his height: {}".format(height_athlete, height)
        )
